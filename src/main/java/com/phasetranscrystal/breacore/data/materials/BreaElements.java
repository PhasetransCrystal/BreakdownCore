...
import static com.phasetranscrystal.breacore.api.registry.BreaRegistries.ELEMENTS;
...
public class BreaElements {
    ...
    public static Element createAndRegister(long protons, long neutrons, long halfLifeSeconds, String decayTo,
        ...
        ELEMENTS.register(BreaUtil.byPath(name), element);
        return element;
    }
    ...
    public static Optional<Element> get(String name) {
        return ELEMENTS.get(BreaUtil.byPath(name)).map(Holder.Reference::value);
    }
}
